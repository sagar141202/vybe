...
const styles = StyleSheet.create({
  ...
  timerText: { fontSize: 32, fontFamily: 'Outfit_900Black', fontWeight: '900', color: '#1E1B4B', letterSpacing: -1 },
  timerSub: { fontSize: 12, color: '#6B7280', fontWeight: '500' },
  section: { paddingHorizontal: 24, marginBottom: 24 },
  sectionTitle: { fontSize: 16, fontFamily: 'Outfit_900Black', fontWeight: '800', color: '#1E1B4B', marginBottom: 14 },
  ...
  durationText: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600', color: '#6B7280' },
  durationTextActive: { color: '#1D4ED8', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700' },
  activeInfo: {
  ...
  activeInfoTitle: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#1E1B4B', marginBottom: 2 },
  ...
  startBtnText: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#FFFFFF' },
  cancelBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 10, paddingVertical: 16, borderRadius: 30, overflow: 'hidden',
    borderWidth: 1.5, borderColor: 'rgba(252,165,165,0.4)',
  },
  cancelBtnText: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#EF4444' },
  infoCard: {
