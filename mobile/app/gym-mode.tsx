...
const sliderStyles = StyleSheet.create({
  ...
  bpmLabel: { fontSize: 22, fontFamily: 'Outfit_900Black', fontWeight: '900', color: '#1E1B4B' },
  ...
  thumbText: { fontSize: 10, color: '#FFFFFF', fontFamily: 'Outfit_900Black', fontWeight: '900' },
  scale: { flexDirection: 'row', justifyContent: 'space-between' },
  scaleTick: { fontSize: 9, color: '#9CA3AF', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600' },
});
...
const styles = StyleSheet.create({
  ...
  toggleText: { fontSize: 12, fontFamily: 'Outfit_900Black', fontWeight: '800', color: '#EA580C', letterSpacing: 1 },
  ...
  heroTitle: { fontSize: 24, fontFamily: 'Outfit_900Black', fontWeight: '900', color: '#1E1B4B' },
  ...
  savedText: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#065F46' },
  sliderSection: { paddingHorizontal: 24, marginBottom: 24 },
  sectionTitle: { fontSize: 16, fontFamily: 'Outfit_900Black', fontWeight: '800', color: '#1E1B4B', marginBottom: 12 },
  ...
  presetLabel: { fontSize: 12, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#1E1B4B' },
