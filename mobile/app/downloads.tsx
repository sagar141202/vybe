...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, textAlign: 'center', fontSize: 17, fontFamily: 'Outfit_900Black', fontWeight: '800', color: '#1E1B4B' },
  ...
  offlineText: { fontSize: 13, color: '#059669', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600' },
  ...
  heroTitle: { fontSize: 26, fontFamily: 'Outfit_900Black', fontWeight: '900', color: '#1E1B4B', marginBottom: 4 },
  ...
  playAllText: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#065F46' },
  ...
  emptyTitle: { fontSize: 20, fontFamily: 'Outfit_900Black', fontWeight: '800', color: '#1E1B4B', marginBottom: 8 },
  ...
  searchBtnText: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#065F46' },
