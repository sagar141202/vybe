...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#1E1B4B' },
  ...
  searchInput: { flex: 1, fontSize: 15, color: '#1E1B4B', fontFamily: 'PlusJakartaSans_500Medium', fontWeight: '500' },
  searchBtn: { paddingVertical: 15, borderRadius: 30, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', marginBottom: 28 },
  searchBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#FFFFFF' },
  suggestionsTitle: { fontSize: 16, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: -0.5, color: '#1E1B4B', marginBottom: 14 },
  ...
  suggestionLabel: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600', color: '#1E1B4B' },
  resultsHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 },
  resultsTitle: { fontSize: 18, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#1E1B4B' },
  ...
  playAllText: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#FFFFFF' },
  ...
  resultInfo: { flex: 1 },
  resultTitle: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#1E1B4B', marginBottom: 2 },
  ...
  matchText: { fontSize: 11, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700' },
  bpmText: { fontSize: 10, color: '#9CA3AF', fontWeight: '600' },
  emptyWrap: { alignItems: 'center', paddingTop: 40, gap: 12 },
  emptyEmoji: { fontSize: 48 },
  emptyTitle: { fontSize: 18, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: -0.5, color: '#1E1B4B' },
