...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#1E1B4B' },
  ...
  actionChipText: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600', color: '#7C3AED' },
  scroll: { paddingHorizontal: 16 },
  section: { marginBottom: 20 },
  sectionLabel: { fontSize: 11, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: -0.5, color: '#9CA3AF', letterSpacing: 1.5, marginBottom: 8, paddingHorizontal: 4 },
  ...
  indexText: { fontSize: 13, color: '#9CA3AF', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600' },
