...
const styles = StyleSheet.create({
  ...
  headerLabel: { fontSize: 11, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: 2, color: 'rgba(255,255,255,0.8)' },
  ...
  trackTitle: { fontSize: 24, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#FFFFFF', letterSpacing: -0.5, marginBottom: 4 },
  trackArtist: { fontSize: 16, color: 'rgba(255,255,255,0.7)', fontFamily: 'PlusJakartaSans_500Medium', fontWeight: '500' },
  ...
  actionLabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600' },
  ...
  lyricsTitle: { fontSize: 24, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#1E1B4B' },
