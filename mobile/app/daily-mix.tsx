    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.content, { transform: [{ translateY: slideAnim }], opacity: opacityAnim }]}>
        ...
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiText}>Generated by Vybe AI based on your listening habits</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  mixBadgeText: { fontSize: 11, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: -0.5, color: '#FFFFFF', letterSpacing: 2 },
  heroTitle: { fontSize: 30, fontFamily: 'Outfit_900Black', fontWeight: '900', letterSpacing: -1, color: '#FFFFFF', letterSpacing: -0.5 },
  ...
  playBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', color: '#FFFFFF' },
  ...
  shuffleBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600', color: '#7C3AED' },
  ...
  emptyTitle: { fontSize: 18, fontFamily: 'Outfit_900Black', fontWeight: '800', letterSpacing: -0.5, color: '#1E1B4B', marginBottom: 8 },
  ...
  trackNum: { width: 22, fontSize: 13, color: '#9CA3AF', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', textAlign: 'center' },
  ...
  trackReason: { fontSize: 11, color: '#A78BFA', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '600' },
  trackRight: { alignItems: 'flex-end', gap: 3 },
  bpmBadge: { fontSize: 10, color: '#A78BFA', fontFamily: 'PlusJakartaSans_700Bold', fontWeight: '700', backgroundColor: 'rgba(167,139,250,0.1)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
